...
#> smart_ore_generation:v1.7.2/load/enumerate
#
...
execute if score #smart_ore_generation.major load.status matches 1 if score #smart_ore_generation.minor load.status matches 7 unless score #smart_ore_generation.patch load.status matches 2.. run scoreboard players set #smart_ore_generation.patch load.status 2
