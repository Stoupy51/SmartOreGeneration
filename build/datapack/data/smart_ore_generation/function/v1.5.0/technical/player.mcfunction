...
#> smart_ore_generation:v1.5.0/technical/player
#
...
execute if score #authorized smart_ore_generation.data matches 1 summon marker run function smart_ore_generation:v1.5.0/technical/authorized
