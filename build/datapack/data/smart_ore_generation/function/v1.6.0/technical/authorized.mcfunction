...
#> smart_ore_generation:v1.6.0/technical/authorized
#
# @within	smart_ore_generation:v1.6.0/technical/player
#
...
execute at @s run function smart_ore_generation:v1.6.0/technical/check_regions with storage smart_ore_generation:params
kill @s
