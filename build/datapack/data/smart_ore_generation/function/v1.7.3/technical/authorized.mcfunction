...
#> smart_ore_generation:v1.7.3/technical/authorized
#
# @executed	at @a
#
# @within	smart_ore_generation:v1.7.3/technical/player
#
...
execute at @s run function smart_ore_generation:v1.7.3/technical/check_regions with storage smart_ore_generation:params
kill @s
