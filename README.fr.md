...
* 📖 Reportez-vous à ce modèle pour le contenu de la fonction [ici](https://github.com/Stoupy51/SmartOreGeneration/blob/main/build/datapack/data/smart_ore_generation/function/v1.7.1/signals/denied_dimensions.mcfunction).
```mcfunction
#> smart_ore_generation:v1.7.1/signals/denied_dimensions
#
...
* 📖 Référez-vous à ce modèle pour le contenu de la fonction [ici](https://github.com/Stoupy51/SmartOreGeneration/blob/main/build/datapack/data/smart_ore_generation/function/v1.7.1/signals/example/generate_ores.mcfunction)
```mcfunction
#> smart_ore_generation:v1.7.1/signals/generate_ores
#
...
execute if score #dimension smart_ore_generation.data matches 0 run function smart_ore_generation:v1.7.1/signals/example/simplunium_ore
execute if score #dimension smart_ore_generation.data matches 0 run function smart_ore_generation:v1.7.1/signals/example/simplunium_ore
execute if score #dimension smart_ore_generation.data matches 0 run function smart_ore_generation:v1.7.1/signals/example/simplunium_ore
execute if score #dimension smart_ore_generation.data matches 0 run function smart_ore_generation:v1.7.1/signals/example/simplunium_ore
# Voir le modèle dans le lien pour le contenu de la fonction smart_ore_generation:v1.7.1/signals/example/simplunium_ore.mcfunction
```
...
* 📖 Référez-vous à ce modèle pour le contenu de la fonction [ici](https://github.com/Stoupy51/SmartOreGeneration/blob/main/build/datapack/data/smart_ore_generation/function/v1.7.1/signals/example/post_generation.mcfunction)
```mcfunction
#> smart_ore_generation:v1.7.1/signals/post_generation
#
...
* 📖 Pour utiliser correctement ce slot, voir le modèle [ici](https://github.com/Stoupy51/SmartOreGeneration/blob/main/build/datapack/data/smart_ore_generation/function/v1.7.1/signals/example/simplunium_ore.mcfunction)
```mcfunction
#> smart_ore_generation:v1.7.1/signals/example/simplunium_ore
#
# @example from SimplEnergy datapack
...
<a href="https://star-history.com/#Stoupy51/SmartOreGeneration&Date">
 <picture>
   ...
   <img alt="Historique des étoiles" src="https://api.star-history.com/svg?repos=Stoupy51/SmartOreGeneration&type=Date" />
 </picture>
</a>
