...
execute unless score #configured smart_ore_generation.data matches 1 run function smart_ore_generation:v1.2/configuration/

# Forceload a region in overworld for a marker
execute in minecraft:overworld run forceload add 0 0
schedule function smart_ore_generation:v1.2/configuration/forceload_marker 5s
schedule function smart_ore_generation:v1.2/configuration/world_bottom_start 5s
