...
scoreboard players operation #output smart_ore_generation.data = _NEXT_RANDOM smart_ore_generation.data
scoreboard players operation #output smart_ore_generation.data %= #max smart_ore_generation.data
