...
#> NAMESPACE:VERSION/signals/generate_ores
#
# @within			#NAMESPACE:v1/signals/generate_ores
...
## Example of a function to generate ores in NAMESPACE:v1/signals/example/generate_ores
